...
public class Transition extends CommonDirectedRelationship {
  ...
  public Element createElement(Project project, Element owner, Element client, Element supplier,
    ...
    com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.Transition transition =
  ...
  public void createReferencedElements(HashMap<String, XMLItem> parsedXML, XMLItem modelElement) {
    ...
    com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdcommunications.Trigger trigger =
        (com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdcommunications.Trigger) Importer
            .getInstance().buildElement(parsedXML, parsedXML.get(triggerID));
  ...
  protected void writeTrigger(org.w3c.dom.Element relationships, Element element) {
    com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.Transition tr =
        (com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.Transition) element;
    Collection<com.nomagic.uml2.ext.magicdraw.commonbehaviors.mdcommunications.Trigger> triggers =
        tr.getTrigger();
    ...
    org.w3c.dom.Element triggerTag =
        XmlWriter.createMtipRelationship(trigger, XmlTagConstants.TRIGGER_TAG);
  ...
  protected void writeParent(org.w3c.dom.Element relationships) {
    ...
    if (owner == null) {
      Logger.log(String.format("No parent found for transition %s with id %s",
          element.getHumanName(), MtipUtils.getId(element)));
      return;
    }

    org.w3c.dom.Element hasParentTag =
        XmlWriter.createMtipRelationship(owner, XmlTagConstants.HAS_PARENT);

...
import org.aero.mtip.metamodel.uaf.operational.OperationalInformation;
import org.aero.mtip.metamodel.uaf.operational.OperationalInformationDiagram;
...
import org.aero.mtip.metamodel.uaf.resources.ResourceInformation;
...
import org.aero.mtip.metamodel.uaf.resources.ResourcesInformation;
import org.aero.mtip.metamodel.uaf.resources.ResourcesProcessFlow;
import org.aero.mtip.metamodel.uaf.resources.ResourcesProcesses;
import org.aero.mtip.metamodel.uaf.resources.ResourcesStructure;
import org.aero.mtip.metamodel.uaf.resources.ResourcesTaxonomy;
...
import org.aero.mtip.metamodel.uaf.strategic.CapabilityRole;
  ...
  public CommonElement createElement(String type, String name, String importId) {
    ...
    switch (type) {
      ...
      case UAFConstants.CAPABILITY_PROPERTY:
        ...
        break;
      case UAFConstants.CAPABILITY_ROLE:
        element = new CapabilityRole(name, importId);
        break;
      ...
      case UAFConstants.OPERATIONAL_ARCHITECTURE:
        ...
        break;
      case UAFConstants.OPERATIONAL_INFORMATION:
        element = new OperationalInformation(name, importId);
        break;
      ...
      // break;
      case UAFConstants.RESOURCES_INFORMATION_DIAGRAM:
         element = new ResourcesInformation(name, importId);
         break;
      ...
      case UAFConstants.OPERATIONAL_HIGH_LEVEL_TAXONOMY:
        ...
        break;
      case UAFConstants.OPERATIONAL_INFORMATION_DIAGRAM:
        element = new OperationalInformationDiagram(name, importId);
        break;
      ...
      // element = new System(name, importId);
      // break;
      case UAFConstants.RESOURCE_INFORMATION:
        element = new ResourceInformation(name, importId);
        break;
